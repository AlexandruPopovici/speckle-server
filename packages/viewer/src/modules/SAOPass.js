...
class SAOPass extends Pass {
	...
	render( renderer, writeBuffer, readBuffer/*, deltaTime, maskActive*/ ) {
		...
		const shdowmapEnabled = renderer.shadowMap.enabled;
		renderer.shadowMap.enabled = false;
		// Rendering readBuffer first when rendering to screen
		// if ( this.renderToScreen ) {

		// 	this.materialCopy.blending = NoBlending;
		// 	this.materialCopy.uniforms[ 'tDiffuse' ].value = this.beautyRenderTarget;
		...
		this.hBlurMaterial.uniforms[ 'tDepth' ].value = writeBuffer.depthTexture
		this.vBlurMaterial.uniforms[ 'tDepth' ].value = writeBuffer.depthTexture
		...
		outputMaterial.blending = CustomBlending;
		outputMaterial.uniforms['tDiffuse'].value = this.saoRenderTarget;
		this.fsQuad.material = outputMaterial;
		renderer.setRenderTarget( readBuffer );
		this.fsQuad.render( renderer );
		// this.renderPass( renderer, outputMaterial, this.renderToScreen ? null : readBuffer );

		if(this.screenOutput) {
			this.materialCopyGamma.uniforms['tDiffuse'].value = readBuffer;
		...
		renderer.shadowMap.enabled = shdowmapEnabled;
	}
